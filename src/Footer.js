    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-col">
          ...
          <p>With graphic design in photoshop & Premeire Pro,moblie & web application with React-Native</p>
        </div>
        ...
        <div className="footer-col">
          ...
          <div className="footer-social">
            <a href="https://wa.me/+256705310166" target="_blank" rel="noreferrer" aria-label="WhatsApp">
            ...
            <a href="https://twitter.com/@ocholapeter12" target="_blank" rel="noreferrer" aria-label="Twitter">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
